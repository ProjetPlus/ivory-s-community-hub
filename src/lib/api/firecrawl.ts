...
export const firecrawlApi = {
  ...
  async map(url: string, options?: { search?: string; limit?: number }): Promise<FirecrawlResponse> {
  ...
  async crawl(url: string, options?: { limit?: number; maxDepth?: number }): Promise<FirecrawlResponse> {
